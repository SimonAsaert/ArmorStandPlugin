	...
	public Prompt acceptInput(ConversationContext con, String message) {
		...
		if (typeUsed.equals(rotationType.BODY)) {
			...
			if (typeUsed.equals(rotationType.HX)) {
				...
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Head X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.HY)) {
				stand.setHeadPose(stand.getHeadPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Head Y angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.HZ)) {
				stand.setHeadPose(stand.getHeadPose().setZ(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Head Z angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.TX)) {
				stand.setBodyPose(stand.getBodyPose().setX(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Chest X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.TY)) {
				stand.setBodyPose(stand.getBodyPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Chest Y angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.TZ)) {
				stand.setBodyPose(stand.getBodyPose().setZ(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Chest Z angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.LAX)) {
				stand.setLeftArmPose(stand.getLeftArmPose().setX(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Left Arm X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.LAY)) {
				stand.setLeftArmPose(stand.getLeftArmPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Left Arm Y angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.LAZ)) {
				stand.setLeftArmPose(stand.getLeftArmPose().setZ(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Left Arm Z angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.RAX)) {
				stand.setRightArmPose(stand.getRightArmPose().setX(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Arm X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.RAY)) {
				stand.setRightArmPose(stand.getRightArmPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Arm Y angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.RAZ)) {
				stand.setRightArmPose(stand.getRightArmPose().setZ(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Arm Z angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.LLX)) {
				stand.setLeftLegPose(stand.getLeftLegPose().setX(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Left Leg X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.LLY)) {
				stand.setLeftLegPose(stand.getLeftLegPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Left Leg Y angle changed to: " + ChatColor.WHITE + degrees);
				...
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Leg X angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.RLY)) {
				stand.setRightLegPose(stand.getRightLegPose().setY(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Leg Y angle changed to: " + ChatColor.WHITE + degrees);
			}else if (typeUsed.equals(rotationType.RLZ)) {
				stand.setRightLegPose(stand.getRightLegPose().setZ(degrees));
				con.getForWhom().sendRawMessage(ChatColor.GOLD + "Right Leg Z angle changed to: " + ChatColor.WHITE + degrees);
			}
		}
